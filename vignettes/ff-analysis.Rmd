...
To generate plots for overall rate of incidence (per 100,000) for each year in each city, and incidence decline use *CascadeCEA-Interventions-3-Plot-NewIncidence.R* found in the *03_Analysis* folder. This script first generates rates of incidence, these results are written into a .csv file which is used to generate a line graph, the script currently produces a plot for 2020-2040, it’s X-axis is “Year” and it’s Y-axis is “Annual number of new infections per 100,000”. Both point estimates and 95% CI are provided. 

[would be nice to have a sample figure for incidence graph described above inserted here]
...
![Figure 5.1 Sample six-panel Health Production Function (HPF) figure. \label{fig:Health Prodcution Function Visualization}](../figs/05_production_function.png) 
